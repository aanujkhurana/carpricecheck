  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        gradient:
          "relative text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 active:scale-[0.98] [background:linear-gradient(135deg,theme(colors.indigo.500),theme(colors.violet.500),theme(colors.fuchsia.500))] hover:[background:linear-gradient(135deg,theme(colors.indigo.400),theme(colors.violet.400),theme(colors.fuchsia.400))]",
        secondary:
